...
**Product Owner & E-Commerce Automatisierer aus Krefeld**

Ich sitze zwischen Business und Tech – und das ist genau mein Vorteil.  
Ich nehme Anforderungen auf, priorisiere sie und setze sie oft direkt selbst um.  
Mit n8n, Synesty Studio und KI-gestütztem Coding automatisiere ich manuelle Prozesse und verbinde digitale Systeme nahtlos miteinander.

---

## 🚀 Was ich mache

- **Workflow-Automatisierung** mit n8n & Synesty Studio → 13 produktive Automations, ~20h/Woche Zeitersparnis
- **E-Commerce Management** auf Shopware 6 & Shopify – inkl. Webshop-Relaunch & Shop-Features
- **KI-gestütztes Coding** mit Claude Code für individuelle Lösungen ohne langen Entwicklungsumweg
- **Product Ownership** – vom Backlog bis zur fertigen Umsetzung, Scrum-erfahren
...
- 🏢 **Product Owner & E-Com-Manager** @ mobene Unternehmensgruppe
- 🚀 **E-Commerce & Automatisierung** @ cStack-Solutions *(selbstständig)*
